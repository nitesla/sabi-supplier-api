...
public class ShipmentController {
    ...
    public ResponseEntity<Response> getAllMasterShipment(@RequestParam(value = "warehouseId",required = false)Long warehouseId,
        ...
        HttpStatus httpCode ;
        Response resp = new Response();
        Page<Shipment> response = service.findAllMasterShipment(warehouseId,logisticPartnerId,logisticsPartnerName,phoneNumber,vehicle,status, PageRequest.of(page, pageSize));
        resp.setCode(CustomResponseCode.SUCCESS);
        resp.setDescription("Record fetched successfully !");
        resp.setData(response);
        httpCode = HttpStatus.OK;
